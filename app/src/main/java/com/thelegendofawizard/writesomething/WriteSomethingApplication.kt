...
import com.thelegendofawizard.writesomething.ui.deleteuser.DeleteUserViewModelFactory
...
class WriteSomethingApplication:Application(), KodeinAware {
    override val kodein = Kodein.lazy {
       ...
       // bind<FirebaseStorageSource>() with singleton { FirebaseStorageSource() }
        ...
        bind<DeleteUserViewModelFactory>() with provider { DeleteUserViewModelFactory(instance(),instance()) }
    }
}
