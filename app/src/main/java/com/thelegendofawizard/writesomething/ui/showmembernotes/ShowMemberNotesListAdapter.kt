...
class ShowMemberNotesListAdapter(private val interaction: Interaction? = null) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return ShowMemberNotesListViewHolder(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (holder) {
            is ShowMemberNotesListViewHolder -> {
    ...
    class ShowMemberNotesListViewHolder
    constructor(
